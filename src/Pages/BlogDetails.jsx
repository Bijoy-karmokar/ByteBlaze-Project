      ...
      <article className="space-y-8 dark:bg-gray-100 dark:text-gray-900">
        <div className="space-y-6">
          ...
          <div className="flex flex-col items-start justify-between w-full md:flex-row md:items-center dark:text-gray-600">
            ...
            <p className="flex-shrink-0 mt-3 text-sm md:mt-0">
              {readable_publish_date} min read • {public_reactions_count} views
            </p>
          </div>
        </div>
        <div className="flex items-start -mx-4 overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap dark:bg-gray-100 dark:text-gray-800">
          ...
          onClick={()=>setTabIndex(0)}
            className={`flex items-center rounded-sm flex-shrink-0 px-5 py-3 space-x-2 ${tabIndex === 0 ? "border border-b-0" : "border-b-0"} dark:border-gray-600 dark:text-gray-600`}
          >
            <svg
